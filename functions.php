...
function qode_styles() {
	...
	global $woocommerce;
        ...
        $responsiveness = "yes";
        if (isset($qode_options_subway['responsiveness']))
            $responsiveness = $qode_options_subway['responsiveness'];
	...
	$fonts_array  = array(
		$qode_options_subway['google_fonts'].':200,300,400',
		$qode_options_subway['page_title_google_fonts'].':200,300,400',
		$qode_options_subway['h1_google_fonts'].':200,300,400',
		$qode_options_subway['h2_google_fonts'].':200,300,400',
		$qode_options_subway['h3_google_fonts'].':200,300,400',
		$qode_options_subway['h4_google_fonts'].':200,300,400',
		$qode_options_subway['h5_google_fonts'].':200,300,400',
		$qode_options_subway['h6_google_fonts'].':200,300,400',
		$qode_options_subway['text_google_fonts'].':200,300,400',
		$qode_options_subway['menu_google_fonts'].':200,300,400',
		$qode_options_subway['dropdown_google_fonts'].':200,300,400',
		$qode_options_subway['dropdown_google_fonts_thirdlvl'].':200,300,400',
		$qode_options_subway['mobile_google_fonts'].':200,300,400',
		$qode_options_subway['button_title_google_fonts'].':200,300,400',
		$qode_options_subway['message_title_google_fonts'].':200,300,400'
	);
...
function qode_scripts() {
	...
	if($qode_options_subway['enable_google_map'] == "yes") :
	...
	if (($qode_options_subway['page_transitions'] != "0") && (empty($qode_animation) || ($qode_animation != "no")))
		$has_ajax = true;
	...
	if($qode_options_subway['use_recaptcha'] == "yes") :
...
add_image_size( 'blog-square', 212, 212, true );
add_image_size( 'menu-featured-post', 345, 198, true );
add_image_size( 'testimonial-image', 47, 47, true );
}
...
function ajax_classes($classes) {
	...
	if(($qode_options_subway['page_transitions'] === "0") && ($qode_animation == "no")) :
		$classes[] = '';
	elseif($qode_options_subway['page_transitions'] === "1" && (empty($qode_animation) || ($qode_animation != "no"))) :
		$classes[] = 'ajax_updown';
		$classes[] = 'page_not_loaded';
	elseif($qode_options_subway['page_transitions'] === "2" && (empty($qode_animation) || ($qode_animation != "no"))) :
		$classes[] = 'ajax_fade';
		$classes[] = 'page_not_loaded';
	elseif($qode_options_subway['page_transitions'] === "3" && (empty($qode_animation) || ($qode_animation != "no"))) :
		$classes[] = 'ajax_updown_fade';
		$classes[] = 'page_not_loaded';
	elseif($qode_options_subway['page_transitions'] === "4" && (empty($qode_animation) || ($qode_animation != "no"))) :
...
function smooth_class($classes) {
	...
	if(!$isMobile){
		if(isset($qode_options_subway['smooth_scroll']) && $qode_options_subway['smooth_scroll'] == "yes"){
			$smooth_scroll = true;
		}
...
function boxed_class($classes) {
	...
	if(isset($qode_options_subway['boxed']) && $qode_options_subway['boxed'] == "yes") :
		$classes[] = 'boxed';
	else:
	$classes[] ="";
	endif;
...
function qode_excerpt_length( $length ) {
	global $qode_options_subway;
	if($qode_options_subway['number_of_chars']){
		 return $qode_options_subway['number_of_chars'];
	} else {
		return 45;
	}
}
...
function the_excerpt_max_charlength($charlength) {
	global $qode_options_subway;
	$via = $qode_options_subway['twitter_via'];
...
function pagination($pages = '', $range = 4, $paged = 1){  
    ...
    if(1 != $pages){
		...
		echo "'><a href='".get_pagenum_link($paged - 1)."'><i class='icon-angle-left'></i></a></li>";
		...
		echo "\"><i class='icon-angle-right'></i></a></li>";  
