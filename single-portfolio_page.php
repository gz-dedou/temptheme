...
if (isset($qode_options_subway['lightbox_single_project'])) 
	$lightbox_single_project = $qode_options_subway['lightbox_single_project'];
...
}elseif(isset($qode_options_subway['portfolio_style'])){
	if($qode_options_subway['portfolio_style'] == 1){
		$porftolio_template = 1;
	}elseif($qode_options_subway['portfolio_style'] == 2){
		$porftolio_template = 2;
	}elseif($qode_options_subway['portfolio_style'] == 3){
		$porftolio_template = 3;
	}elseif($qode_options_subway['portfolio_style'] == 4){
		$porftolio_template = 4;
	}elseif($qode_options_subway['portfolio_style'] == 5){
		$porftolio_template = 5;
	}elseif($qode_options_subway['portfolio_style'] == 6){
		$porftolio_template = 6;
	}
}
...
if(get_post_meta(get_the_ID(), "qode_choose-number-of-portfolio-columns", true) != ""){
	...
	if(isset($qode_options_subway['portfolio_columns_number'])){
		if($qode_options_subway['portfolio_columns_number'] == 2){
			$columns_number = "v2";
		} else if($qode_options_subway['portfolio_columns_number'] == 3) {
			$columns_number = "v3";
		} else if($qode_options_subway['portfolio_columns_number'] == 4) {
			$columns_number = "v4";
		}
	}
}
				...
				<div class="container_inner clearfix">
					<div class="portfolio_single">
						...
						<div class="portfolio_navigation">
							<div class="portfolio_prev"><?php previous_post_link('%link', '<i class="icon-angle-left"></i>' . __('Previous','qode')); ?></div>
							...
							<?php } ?>
							<div class="portfolio_next"><?php next_post_link('%link', __('Next','qode').'<i class="icon-angle-right"></i>'); ?></div>
						</div>
