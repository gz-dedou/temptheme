<?php 
/*
Template Name: Contact Page Map in Grid
*/ 
?>
...
if (isset($qode_options_subway['hide_contact_form_website'])) $hide_contact_form_website = $qode_options_subway['hide_contact_form_website'];
...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<?php } ?>
		<?php if($qode_options_subway['enable_google_map'] == "yes"){ ?>
			<div class="container">
				<div class="container_inner clearfix">
		...
		<?php } ?>
	<div class="container">
		<div class="container_inner clearfix<?php echo $container_class; ?>">
					<?php if($qode_options_subway['enable_contact_form'] == "yes"){ ?>
					<div class="two_columns_66_33 clearfix grid2">
						<div class="column1">
							<div class="column_inner">
								<div class="contact_form">
									<h3><?php if($qode_options_subway['contact_heading_above'] != "") { echo $qode_options_subway['contact_heading_above'];  } else { ?><?php _e('CONTACT US', 'qode'); ?><?php } ?></h3>
									<form id="contact-form" method="post" action="">
										...
										<span class="submit_button_contact">
											<input class="qbutton with_shadow" type="submit" value="<?php _e('CONTACT US', 'qode'); ?>" />
										</span>
									</form>	
								</div>	
							</div>
